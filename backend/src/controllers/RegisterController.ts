...
export const setupAccountWithExampleData = async (
  ...
  const adminPermissions: RolePermissions = {
    ...
    campaigns: { browse: true, read: true, edit: true, add: true, delete: true, assign: true },
    emails: { browse: true, read: true, edit: true, add: true, delete: true, assign: true },
  ...
  const memberPermissions: RolePermissions = {
    ...
    campaigns: { browse: true, read: true },
    emails: { browse: true, read: true },
