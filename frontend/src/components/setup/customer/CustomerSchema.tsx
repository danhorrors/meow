...
export const CustomerSchema = ({ isDeveloperMode }: CustomerSchemaProps) => {
  ...
  return (
    <div className="content-box">
      <div className="schema-editor-header">
        <div className="title">
          <h2>{Translations.CustomersTitle[DEFAULT_LANGUAGE]}</h2>
        </div>
        {isDeveloperMode ? (
          <div className="endpoint">
            <b>POST/GET:</b> {protocol}//{domain}/api/customers
          </div>
        ) : null}
      </div>
