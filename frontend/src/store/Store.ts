...
export const selectCustomers = (store: RootState) => store.customers;
...
export const selectCustomer = (store: ApplicationStore, id: string | undefined) =>
  store.customers.find((customer) => customer._id === id);
